...
def generate_sign_language_video(input_text, folder_video="/app/video_kata"):
    """
    ...
    for kata in kata_kunci:
        ...
        if awalan_ditemukan:
            nama_file_awalan = f"Awalan-{awalan_ditemukan.capitalize()}.webm"
        ...
        nama_file_dasar = f"{kata_dasar.capitalize()}.webm"
    ...
    if list_klip_video:
        ...
        output_path = "hasil_terjemahan_sibi.mp4"
